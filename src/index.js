...
const num = 1300;
// console.log(num.toLocaleString());//toLocaleStringは金額表示してくれるjavascriptの関数
...
// ||このパイプライン二つは左側がfalseなら右側を返すという意味
const num = null; //javascriptはnullはfalse判定になる
